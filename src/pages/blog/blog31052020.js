...
export default class extends Component {
  render() {
    ...
    const disqusConfig = {
      url: "http://www.blogpi2.online/blog/blog310452020", //this.props.pageUrl
    ...
    return (
      <Layout>
        ...
        <h5 class="centerH1"><p>por: Leonardo Kawasaki | 31/04/2020</p></h5>
        <div class="postagem">
          <p>
            Outro recurso solicitado para essa entrega foi a adição do Disqus. O Disqus é um serviço 
					...
					<p>
						...
						<a href="https://coderrocketfuel.com/article/how-to-add-disqus-to-a-react-application">Este tutorial me 
						auxiliou nesta tarefa.</a>
					</p>
        </div>
        <br></br>
